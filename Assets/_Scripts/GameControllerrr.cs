...
public class GameControllerrr : MonoBehaviour
{
    ...
    [Header("Prefabs")]
    [SerializeField] private SuspectHandlerrr suspectHandlerPrefab;
    ...
    {        
        ...
        SuspectHandlerrr suspectObj = Instantiate(suspectHandlerPrefab.gameObject, position, Quaternion.identity).GetComponent<SuspectHandlerrr>();
        suspectObj.gameControllerrr = this;
    ...
    {        
        ...
        SuspectHandlerrr suspectObj = Instantiate(suspectHandlerPrefab.gameObject, Vector3.zero, Quaternion.identity).GetComponent<SuspectHandlerrr>();
        suspectObj.gameControllerrr = GetComponent<GameControllerrr>();
        suspectObj.ApplyMaskFromData(mask);
