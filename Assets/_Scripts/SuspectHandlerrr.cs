...
public class SuspectHandlerrr : MonoBehaviour
{
    [Header("Dependencias")]
    [SerializeField] public GameControllerrr gameControllerrr;
    ...
    public void ApplyMaskFromData(string maskData)
    {
        ...
        eyes.sprite = gameControllerrr.AntifaceSprites[eyeIndex];
        nose.sprite = gameControllerrr.HatSprites[noseIndex];
        mouth.sprite = gameControllerrr.AccesorySprites[mouthIndex];
    }
}
